(function () {
  'use strict';
  App.controller('MainCtrl', ['$scope', 'QueryService', 'Notification', 'ExportDownload', 'Pdf', '$localStorage',
    function ($scope, QueryService, Notification, ExportDownload, Pdf, $localStorage) {
      ...
      $scope.print = function () {
        ...
        ExportDownload.pdfByteBase64(exportedData, "print", "filename").then(function (response) {
          ...
          $localStorage.pdfPrintData = response;
          window.open("viewer.html?data=" + pdfData, '_blank');
        })
